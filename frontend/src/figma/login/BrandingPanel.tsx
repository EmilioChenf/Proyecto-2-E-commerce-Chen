...
export function BrandingPanel() {
  return (
    <div className="hidden lg:flex lg:w-1/2 brand-hero-gradient p-12 flex-col justify-between text-[#10231f] relative overflow-hidden">
      ...
      <div className="relative z-10">
        <div className="flex items-center gap-3 mb-4">
          <div className="w-12 h-12 bg-white/20 rounded-2xl flex items-center justify-center backdrop-blur-sm">
            <Heart className="text-[var(--primary-hover)]" size={28} fill="currentColor" />
          </div>
          <h1 className="text-3xl">PlushStore</h1>
        </div>
        <p className="text-[#31534c] text-lg">Sistema de Gestión de Tienda</p>
      </div>
      ...
      <div className="relative z-10 space-y-8">
        <div>
          ...
          <p className="text-[#31534c] text-lg">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-4">
            ...
            <p className="text-sm text-[#31534c]">Control en tiempo real</p>
          </div>
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-4">
            <div className="w-10 h-10 bg-white/20 rounded-xl flex items-center justify-center mb-3">
              <Star size={20} />
            ...
            <p className="text-sm text-[#31534c]">Reportes detallados</p>
          </div>
        </div>
      </div>

      <div className="relative z-10 text-sm text-[#31534c]">
