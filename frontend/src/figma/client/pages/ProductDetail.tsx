    ...
    <div className="min-h-screen brand-page-bg">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <nav className="mb-8 text-sm text-gray-600">
          <Link to="/cliente" className="hover:text-[var(--primary-hover)]">
            Inicio
          </Link>
          <span className="mx-2">/</span>
          <Link to="/catalogo" className="hover:text-[var(--primary-hover)]">
            Catalogo
          </Link>
          <span className="mx-2">/</span>
        ...
        <div className="bg-white rounded-2xl shadow-lg overflow-hidden mb-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 p-8">
            <div className="relative">
              ...
              {product.isNew && (
                <span className="absolute top-4 left-4 bg-[var(--color-primary)] text-white px-4 py-2 rounded-full font-bold">
                  Nuevo
                </span>
              )}
              {product.isBestSeller && (
                <span className="absolute top-4 right-4 bg-[var(--color-secondary)] text-white px-4 py-2 rounded-full font-bold flex items-center space-x-1">
            ...
            <div className="flex flex-col">
              ...
              <div className="brand-page-bg rounded-xl p-4 mb-6">
                <div className="flex items-center space-x-3 mb-3">
                ...
                {product.stock > 0 ? (
                  <div className="flex items-center space-x-2">
                    <span className="w-3 h-3 bg-[var(--color-primary)] rounded-full" />
                  ...
                  <div className="flex items-center space-x-2">
                    <span className="w-3 h-3 bg-[rgba(173,235,179,0.7)] rounded-full" />
              ...
              <button
                ...
                className={`w-full py-4 rounded-full font-bold text-lg transition flex items-center justify-center space-x-3 mb-4 ${
                  product.stock === 0
                    ...
                    : 'brand-primary-gradient text-[#10231f]  shadow-lg hover:shadow-xl'
                }`}
              >
              ...
              <Link
                to="/catalogo"
                className="w-full py-4 rounded-full font-bold text-lg transition flex items-center justify-center border-2 border-gray-300 text-gray-700 hover:border-[var(--color-primary)] hover:text-[var(--primary-hover)]"
              >
                Seguir Comprando
              </Link>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {relatedProducts.map((relatedProduct) => (
                ...
                >
                  ...
                  <div className="p-5">
                    <p className="text-xs text-[var(--primary-hover)] font-semibold mb-1">
